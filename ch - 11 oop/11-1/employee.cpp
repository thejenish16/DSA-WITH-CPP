...
int main()
{
     ...
     cout << "Entar Employee id :";
     cin >> employee1.emp_id;
     cout << "Entar Employee name :";
     cin >> employee1.emp_name;
     cout << "Entar Employee age :";
     cin >> employee1.emp_age;
     cout << "Entar Employee role :";
     cin >> employee1.emp_role;
     cout << "Entar Employee salary :";
     cin >> employee1.emp_salary;
     cout << "Entar Employee city :";
     cin >> employee1.emp_city;
     cout << "Entar Employee experience :";
     cin >> employee1.emp_experience;
     cout << "Entar Employee company_name:";
     ...
     cout << "Employee experience\t:" << employee1.emp_experience << endl;
     cout << "Employee name\t:" << employee1.emp_company_name << endl;
     ...
     cout << "Employee experience\t:" << employee2.emp_experience << endl;
     cout << "Employee name\t:" << employee2.emp_company_name << endl;
     ...
     cout << "Employee experience\t:" << employee3.emp_experience << endl;
     cout << "Employee name\t:" << employee3.emp_company_name << endl;
     ...
     cout << "Employee experience\t:" << employee4.emp_experience << endl;
     cout << "Employee name\t:" << employee4.emp_company_name << endl;
     cout << endl
          << endl
          << "Entar output......." << endl
          << endl;
     ...
     cout << "Employee experience\t:" << employee5.emp_experience << endl;
     cout << "Employee name\t:" << employee5.emp_company_name << endl;
}
